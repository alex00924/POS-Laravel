...
-->
@extends('layouts.app')
@section('title', 'Rejected Bullets')
    ...
    <section class="content no-print">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title mt-5">Rejected bullets</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped ajax_view" id="points_table" data-url = '/superadmin/points/rejected'>
                        <thead>
                        <tr>
                            <th>Date</th>
                            <th>Business Name</th>
