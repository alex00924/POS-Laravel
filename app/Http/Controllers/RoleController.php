...
use App\BusinessLocation, App\SellingPriceGroup;
...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $locations = BusinessLocation::where('business_id', $business_id)
                                    ->get();
        $selling_price_groups = array();
        foreach($locations as $location)
        {
            $selling_price_groups[$location->id] = SellingPriceGroup::where('location_id', $location->id)
                ->get();
        }
        $is_delivery = Subscription::can_delivery($business_id);
        return view('role.create')
                ->with(compact('locations', 'selling_price_groups', 'is_delivery'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('role.edit')
            ->with(compact('role', 'role_permissions', 'locations', 'selling_price_groups', 'is_delivery'));
    }
