...
<section class="content">
  <div class="box">
    <div class="box-body">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class='col-md-6' style='border:1px solid #eee'>
            <h5>{!!$location->name!!}</h5>
              @foreach($selling_price_groups[$location->id] as $selling_price_group)
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
      ...
      <div class="row">
        <div class="col-md-3">
          <h4>@lang( 'role.access_delivery' )</h4>
        </div>
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'access_delivery', in_array('access_delivery', $role_permissions), 
                [ 'class' => 'input-icheck']); !!} {{ __( 'role.delivery' ) }} 
                </label>
            </div>
          </div>
        </div>
