...
<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="radio" value="0" checked id="{!! __('business.business_store') !!}_0" name="{!! __('business_type') !!}" style='margin-left:30px'>
        <label for="{!! __('business.business_store') !!}_0" style='cursor:pointer; font-weight:normal'>{!! __('business.business_store') !!}</label> 
        <input type="radio" value="1" id="{!! __('business.business_restaurant') !!}_1" name="{!! __('business_type') !!}" style='margin-left:30px'>
        <label for="{!! __('business.business_restaurant') !!}_1" style='cursor:pointer; font-weight:normal'>{!! __('business.business_restaurant') !!}</label> 
        <!-- {!! Form::radio('business_type', 0, true); !!}
        
        {!! Form::radio('business_type', 1, false); !!} -->
