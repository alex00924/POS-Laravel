...
return [
    ...
    "search_product_mobile_placeholder" => "Enter Mobile Unique Code",
    "search_mobile_transaction" => "Enter Invoice No.",
    "recent_mobile_transactions" => "Recent Mobile Card Transactions",
	'fixed' => 'Fixed',
   ...
   'express_checkout_card_machine' => "CardMachine",
   ...
   'tooltip_express_checkout_card_machine' => 'Express checkout using card machine',
   ...
   'delivery_is_minimum' => 'Minimum Order Price For Free Delivery?',
   'delivery_minimum' => 'Minimum Order Price For Free Delivery',
   'delivery_email' => 'Email for Receiving Order Details',
   'delivery_is_all' => 'Delivery All Products?',
   'delivery_tax_type' => 'Delivery Price Tax Type',
   'delivery_applicable_tax' => 'Applicable Tax on Delivery Charge',
   'delivery_is_delivery' => 'Enable/Disable Delivery'
];