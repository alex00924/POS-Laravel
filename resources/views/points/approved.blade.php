    ...
    <section class="content no-print">
        ...
        <div class="box">
            <div class="box-header">
                ...
                {{--<div class="charts row" style="height: 370px; max-width: 100%; margin: 0 auto;">--}}
                    {{--<div class="col-md-6" id="chartContainer" style="height: 100%; max-width: 50%; margin: 0 auto;"></div>--}}
                    {{--<div class="col-md-6" id='single_chart' style="height: 100%; max-width: 50%; margin: 0 auto;"></div>--}}
                {{--</div>--}}
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped ajax_view" id="points_table" data-url = '/points/approved'>
                        <thead>
                        <tr>
                            <th>Date</th>
                            <th>Bullets</th>
