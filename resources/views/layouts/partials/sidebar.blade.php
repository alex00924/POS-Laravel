...
<!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- 2019.01.07 caixia -->
          @can('superadmin')
              <li class="treeview {{ $request->segment(2) == 'points' ? 'active active-sub' : '' }}" id="tour_step0">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ $request->segment(2) == 'points' && $request->segment(3) == null ? 'active' : '' }}">
                          <a href="{{action('\Modules\Superadmin\Http\Controllers\PointsController@index')}}"><i class="fa fa-bell"></i>Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'superadmin' && $request->segment(3) == 'requested' ? 'active' : '' }}">
                          <a href="{{action('\Modules\Superadmin\Http\Controllers\PointsController@requestedPoints')}}"><i class="fa fa-arrow-circle-right"></i>Requested Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'superadmin' && $request->segment(3) == 'approved' ? 'active' : '' }}">
                          <a href="{{action('\Modules\Superadmin\Http\Controllers\PointsController@approvedPoints')}}"><i class="fa fa-check-circle"></i>Approved Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'superadmin' && $request->segment(3) == 'rejected' ? 'active' : '' }}">
                          <a href="{{action('\Modules\Superadmin\Http\Controllers\PointsController@rejectedPoints')}}"><i class="fa fa-arrow-circle-left"></i>Rejected Bullets</a>
                      </li>
                  </ul>
              </li>
          @endcan
          @cannot('superadmin')
              <li class="treeview {{ $request->segment(1) == 'points' ? 'active active-sub' : '' }}" id="tour_step0">
                  <a href="#" id="tour_step6_menu">
                      <i class="fa fa-info-circle"></i>
                      <span>Bullets</span>
                      <span class="pull-right-container">
                  ...
                  <ul class="treeview-menu">
                      <li class="{{ $request->segment(1) == 'points' && $request->segment(2) == null ? 'active' : '' }}">
                          <a href="{{action('PointsController@index')}}"><i class="fa fa-bell"></i>Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'points' && $request->segment(2) == 'requested' ? 'active' : '' }}">
                          <a href="{{action('PointsController@requestedPoints')}}"><i class="fa fa-arrow-circle-right"></i>Requested Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'points' && $request->segment(2) == 'approved' ? 'active' : '' }}">
                          <a href="{{action('PointsController@approvedPoints')}}"><i class="fa fa-check-circle"></i>Approved Bullets</a>
                      </li>
                      <li class="{{ $request->segment(1) == 'points' && $request->segment(2) == 'rejected' ? 'active' : '' }}">
                          <a href="{{action('PointsController@rejectedPoints')}}"><i class="fa fa-arrow-circle-left"></i>Rejected Bullets</a>
                      </li>
                  </ul>
              </li>
          @endcannot
      <!-- Bullets end -->
        ...
        @if(auth()->user()->can('access_delivery') && in_array('delivery', $enabled_modules))
        <li class="treeview {{  in_array( $request->segment(1), ['delivery-categories', 'delivery']) ? 'active active-sub' : '' }}">
          <a href="#"><i class="fa fa-shopping-cart"></i> <span>@lang('delivery.delivery')</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="{{ $request->segment(1) == 'delivery' && $request->segment(2) == 'new' ? 'active' : '' }}"><a href="{{action('DeliveryController@newDelivery')}}"><i class="fa fa-newspaper-o"></i>@lang('delivery.new_orders')</a></li>
            <li class="{{ $request->segment(1) == 'delivery' && $request->segment(2) == 'pending' ? 'active' : '' }}"><a href="{{action('DeliveryController@pendingDelivery')}}"><i class="fa fa-newspaper-o"></i>@lang('delivery.pending_orders')</a></li>
            <li class="{{ $request->segment(1) == 'delivery' && $request->segment(2) == 'complete' ? 'active' : '' }}"><a href="{{action('DeliveryController@completeDelivery')}}"><i class="fa fa-envelope-o"></i>@lang('delivery.complete_orders')</a></li>
            <li class="{{ $request->segment(1) == 'delivery' && $request->segment(2) == 'uncomplete' ? 'active' : '' }}"><a href="{{action('DeliveryController@uncompleteDelivery')}}"><i class="fa fa-window-close"></i>@lang('delivery.uncomplete_orders')</a></li>
          </ul>
        </li>
        @endif
