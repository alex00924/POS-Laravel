...
class SellingPriceGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $price_groups = SellingPriceGroup::where('location_id', $location)
        ...
        return view('selling_price_group.index')->with(compact('locations', 'location'));
    }
    ...
    public function create($location)
    {
        ...
        return view('selling_price_group.create')->with(compact('location'));
    }
