...
function updateProfitLoss(){
    ...
    var loader = __fa_awesome();
    $('.opening_stock, .total_transfer_shipping_charges, .closing_stock, .total_sell, .total_purchase, .total_expense, .net_profit, .total_adjustment, .total_recovered, .total_sell_discount, .total_bullet, .total_purchase_discount').html(loader);
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('.total_delivery').html(__currency_trans_from_en( data.total_delivery, true ));
