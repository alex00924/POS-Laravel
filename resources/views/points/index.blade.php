    ...
    <section class="content no-print">
        ...
        <div class="box">
            <div class="box-header">
                {!! Form::open(['url' => action('PointsController@index'), 'method' => 'get', 'id' => 'bussiness_loc_form']) !!}
                    <div class="row">
                ...
                <h3 class="box-title mt-5">Bullets history</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped ajax_view" id="points_table" data-url = '/points'>
                        <thead>
                        <tr>
                            <th>Date</th>
                            <th>Bullets</th>
                        ...
                        <tr class="bg-gray font-17 text-center footer-total">
                            ...
                            <td><strong>Calculated Price:</strong></td>
