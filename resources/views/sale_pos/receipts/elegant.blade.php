...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50">
		...
		@endif
		<!-- Total Bullet-->
		@if(!empty($receipt_details->total_bullet))
			<p class="text-right font-23 color-555">
				<span class="pull-left">{!! $receipt_details->total_bullet_label !!}</span>
				{{$receipt_details->total_bullet}}
			</p>
		@endif
		<!-- Date-->
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100">
			<tbody>
				...
				<!-- Delivery -->
				@if( !empty($receipt_details->delivery) )
					<tr class="color-555">
						<td>
							{!! $receipt_details->delivery_label !!}
						</td>

						<td class="text-right">
							(+) {{$receipt_details->delivery}}
						</td>
					</tr>
				@endif
				
				<!-- Delivery tax -->
				@if( !empty($receipt_details->delivery_tax) )
					<tr class="color-555">
						<td>
							{!! $receipt_details->delivery_tax_label !!}
						</td>

						<td class="text-right">
							(+) {{$receipt_details->delivery_tax}}
						</td>
					</tr>
				@endif
