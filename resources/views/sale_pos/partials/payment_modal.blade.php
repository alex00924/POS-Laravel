...
<!-- Used for express checkout card machine transaction -->
<div class="modal fade" tabindex="-1" role="dialog" id="card_machine_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {!! Form::label("receipt_number", __('lang_v1.receipt_no')) !!}
                            {!! Form::text("", null, ['class' => 'form-control', 'placeholder' => __('lang_v1.receipt_no'), 'id' => "receipt_number", 'autofocus']); !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="pos-save-card-machine">@lang('sale.finalize_payment')</button>
            </div>
