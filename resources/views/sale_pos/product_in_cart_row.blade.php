    ...
    @if(!empty($product->lot_numbers))
        ...
        <td>
            ...
            <div class="input-group input-number">
                ...
                <input readonly type="text" data-min="1" class="form-control pos_quantity input_number mousetrap" value="{{@num_format($product->quantity_ordered)}}" name="products[{{$row_count}}][quantity]"
